...
export const getSeedHex = curry((imports, state, password) =>
  compose(
    Wallet.getSeedHex(imports, password),
    getWallet
  )(state)
)
export const getMnemonic = curry((imports, state, password) =>
  compose(
    Wallet.getMnemonic(imports, password),
    getWallet
  )(state)
)
